      ...
      <el-col :span="12" :offset="4">
        <el-form :model="formData" :rules="rules" ref="formData" label-width="110px" class="demo-formData">
          ...
          <el-form-item label="店铺特点" style="white-space: nowrap;">
            <span>品牌保证</span>
            <el-switch active-text="" inactive-text="" v-model="formData.is_premium"></el-switch>
            <span>蜂鸟专送</span>
            <el-switch active-text="" inactive-text="" v-model="formData.delivery_mode"></el-switch>
            <span>新开店铺</span>
            <el-switch active-text="" inactive-text="" v-model="formData.new"></el-switch>
          </el-form-item>
          <el-form-item style="white-space: nowrap;">
            <span>外卖保</span>
            <el-switch active-text="" inactive-text="" v-model="formData.bao"></el-switch>
            <span>准时达</span>
            <el-switch active-text="" inactive-text="" v-model="formData.zhun"></el-switch>
            <span>开发票</span>
            <el-switch active-text="" inactive-text="" v-model="formData.piao"></el-switch>
          </el-form-item>
...
export default {
  ...
  methods: {
    async initData() {
      try {
        const cur_city = await cityGuess()
        // console.log(cur_city.data)
        this.city = cur_city.data
